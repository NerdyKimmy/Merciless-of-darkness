...
tip_list_1=["Make sure you equip your item after crafting","It is always good to have at least 1 healing potion before entering a dungeon","Remember you cannot escape or flee from a battle in the dungeon",
         "If you want to make life easier I would recommend to learn at least a spell or two", "There is a wizard called 'Pug' at port 'The Sea's Biscuits' who might be able to help with your memory",
          "There is another human settlement North East from here called 'Gloom Watch'"]
...
tip_list_3=["Dungeon of Akalabeth is north east of here. There is a war between Chaos Spiders and Demons raging within the dungeon.","Dungeon of Daggerfall is North of here. There is a war between Iron Golems and Ratlings raging within the dungeon.","Remember you cannot escape or flee from a battle in the dungeon",
           "Cultist Temple is West of here. You might want to start there if the other dungeons close by are too hard for you","The port name 'The Sea Biscuits' is South East from here","The Old Doom Wizard 'Gotguk' is looking for a pupil. He is in those caves North East of here","There is a secret group of assassins called 'The Shadow Hunters'. Their Leader is called Nine Dead Eyes","Go to the Temples if you want to be a Holy Knight"]

tip_list_4=["The Red Hawk Training camp is south west from here","I hear there is a Goblin Shaman within the Caves of Profound Misery who can cross the Bed of Souls "," South across the waters is where you will find the Blood Pit of Telpo",
            "The Doom King of the Heretic Hand is across the Bed of Souls","Explore the caves to find hidden secrets","The most dangerous dungeons are within caves","You will find certain dungeons provide higher chance to attain specific material"]
